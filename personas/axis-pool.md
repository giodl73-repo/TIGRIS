...
|---|---:|---:|---:|---:|---|---|
| A1 Elegance | 72 | 0 | 2 | 0 | **adopted** | Prior 47 + fast-track batch (+25 earns across 81 games; earns at Ingenious#77, Onitama#81, Medici#83, NMBR9#95, Go#136, Chess#135, High Society#150, etc.). Post-batch: **72E career high.** |
| A2 Decision Density | 84 | 0 | 0 | 1 | **adopted** | Prior 49 + fast-track (+35 earns; earns at medium-heavy games Coimbra, 7WD, Ark Nova, Concordia, etc.). Post-batch: **84E career high.** |
| A3 Interaction | 88 | 0.5 | 2 | 1 | **adopted (recovered v2.23; cycle 3)** | Prior 48 + fast-track (+40 earns; nearly every game with interaction). Post-batch: 88E. |
| A4 Variance Calibration | 46 | 0 | 0 | 0 | **adopted** | Prior 26 + fast-track (+20 earns; Sushi Go, Qwixx, Wavelength, Wits&Wagers, Heat, Welcome To, Sagrada, etc.). Post-batch: 46E. |
| A5 Downtime / Pacing | 37 | 1.0 | 0 | 0 | **adopted** | Prior 17 + fast-track (+20 earns; simultaneous/fast games, 7W, 7WD, RftG pattern). Post-batch: 37E. |
| A6 Teachability | 99 | 0 | 1 | 0 | **adopted** | Prior 49 + fast-track (+50 earns; teachability near-universal at lighter weights). Post-batch: **99E career high.** |
| A7 Emergence / Replayability | 49 | 0 | 1 | 0 | **adopted (recovered v2.21; cycle 2)** | Prior 34 + fast-track (+15 earns; games with genuine cross-game variety — Wingspan Oceania, Everdell, etc.). Post-batch: 49E. |
| B1 System Gearing | 54 | 1.5 | 0 | 0 | **adopted** | Prior 29 + fast-track (+25 earns; heavy production — Concordia, Everdell, GWT, Ark Nova, CO2, Gallerist, Vinhos, Kanban EV, Weather Machine, On Mars, Underwater Cities, Yokohama, Arnak, Coimbra, etc.). Post-batch: 54E. |
| B2 Catastrophe Pressure | 35 | 7.0 | 0 | 0 | **adopted (concern resolved)** | Prior 20 + fast-track (+15 earns; Can't Stop, Clank, Pandemic, Spirit Island-sibs, Heat, Betrayal, Sleeping Gods, etc.). Post-batch: 35E/7.0R. |
| B3 Conversion Chain Depth | 23 | 7.5 | 0 | 0 | **adopted** | Prior 11 + fast-track (+12 earns; Glass Road, Star Realms, GWT, Bohnanza chain, Ora et Labora, Clank, Caverna, Fields of Arle, Hallertau, Dominion: Intrigue). Post-batch: 23E/7.5R. |
| B4 Information Transparency Cost | 31 | 11.5 | 0 | 0 | **adopted** | Prior 11 + fast-track (+20 earns; Kanban EV, Vinhos, Whitechapel, Weather Machine, On Mars, Escape Plan, Gallerist, Mysterium, Dixit, Coup, Resistance, Spyfall, Skull, Mastermind hidden-info, Sheriff, Insider, Bridge, High Society). Post-batch: 31E. |
| B5 Architectural Novelty | 19 | 14.5 | 0 | 0 | **adopted (clock reset)** | Prior 11 + fast-track (+8 earns; novel architectures — Hive, Klask, Space Alert, Wavelength, The Mind, Skull, Mysterium, Dixit). Post-batch: 19E. |
| B6 Scoring Multiplier Dependency | 19 | 2.5 | 0 | 0 | **adopted** | Prior 11 + fast-track (+8 earns; multiplier games — Everdell, Ark Nova, Concordia, Terra Mystica-family, 7WD, Arnak, Modern Art, Medici). Post-batch: 19E. |
| C1 Tension Budget | 85 | 0 | 0 | 2 | **adopted** | Prior 50 + fast-track (+35 earns; tension near-universal — Knizia corpus anchor; No Thanks, High Society, For Sale, Modern Art, Medici, Citadels, Love Letter, Coup, etc.). Post-batch: **85E CAREER HIGH.** |
| C2 Minimum-Score Shape | 11 | 26.0 | 0 | 0 | **adopted (monitoring — high retire-explicit)** | Prior 5 + fast-track (+6 earns; Can't Stop partial, Patchwork Doodle, Patchwork Express, Ingenious CANONICAL at 1.70w, No Thanks, High Society). Retire-explicit +10.0R → 26.0R. Post-batch: 11E/26.0R. **Highest retire-explicit in pool.** |
| C3 Scarcity Bite | 33 | 4.5 | 0 | 1 | **adopted** | Prior 18 + fast-track (+15 earns; scarcity-driven — Caverna anchor, Ora et Labora, Hallertau, Fields of Arle, Bohnanza, Can't Stop). Post-batch: 33E. |
| C4 Engine-Garden Dependency | 21 | 5.5 | 1 | 0 | **adopted** | Prior 11 + fast-track (+10 earns; engine-garden — Everdell, Ark Nova, Yokohama, Ora et Labora, Glass Road, Clank, Caverna, Coimbra). Post-batch: 21E. |
| C5 Anti-Catch-up Pressure | 0 | 3 | 2 | 0 | **RETIRED v2.6** | No changes. |
| C6 Point-Salad Incommensurability | 32 | 10.5 | 0 | 1 | **adopted** | Prior 17 + fast-track (+15 earns; incommensurable scoring — Concordia, Ark Nova, Coimbra, Takenoko, Sagrada, Wingspan-sibs, Arnak, Everdell). Post-batch: 32E. |
| C7 Action-Menu Clarity | 80 | 0 | 0 | 0 | **adopted** | Prior 40 + fast-track (+40 earns; action clarity near-universal at lighter weights — Love Letter, Coup, Sushi Go, Hive, Onitama, Azul SP, Project L, Klask, Just One, etc.). Post-batch: 80E. |
| C8 First-Turn Compression | 12 | 12.5 | 0 | 1 | **adopted (monitoring)** | Prior 7 + fast-track (+5 earns; Turn-1 strategic games — Everdell, Concordia, GWT, Ark Nova, Onitama). Post-batch: 12E. |
| D1 Family-to-Expert Scaling | 59 | 0 | 0 | 2 | **adopted** | Prior 34 + fast-track (+25 earns; family-to-expert — Azul SP, Klask, Sagrada, TTR Europe, Sushi Go, Onitama, Just One, NMBR 9, 7W Architects, Patchwork Express, Qwixx, High Society, etc.). Post-batch: 59E. |
| D2 Spatial-Interaction Presence | 31 | 8.5 | 0 | 0 | **adopted** | Prior 16 + fast-track (+15 earns; spatial — Hive, Chess, Go, Onitama, Takenoko, TTR Europe, Klask, NMBR 9, Sagrada, Azul SP, Whitechapel, Escape Plan, On Mars). Post-batch: 31E. |
| D3 Count-Robustness | 104 | 0 | 0 | 0 | **adopted** | Prior 44 + fast-track (+60 earns; count-robustness near-universal — the most-earned axis in batch). Post-batch: **104E; first axis to reach 100E.** |
| D4 Late-Game Lock-in Point | 46 | 1.0 | 0 | 1 | **adopted** | Prior 34 + fast-track (+12 earns; lock-in — Fields of Arle, Viticulture Tuscany, On Mars, Great Western Trail, Everdell, Concordia, Ark Nova, Arnak, Yokohama, Coimbra, Vinhos, Gallerist). Post-batch: 46E. |
| A25 Emotional Arc | 12 | 0 | 0 | 0 | **adopted v2.24.30** | **First earn: Betrayal#99 (v2.24.30). Second earn: Sleeping Gods#100 (v2.24.31) → A25 ADOPTED.** +12 earns total: Betrayal, Sleeping Gods, Arkham LCG, Mysterium, Dixit, Dixit Odyssey, Insider (emotional arc at narrative-forward games). |
...
| A31 Failure Texture | 1 | 0 | 0 | 0 | **live (FIRST EARN v2.24.85)** | **First earn: RITE #153 (Stegmaier; "I was Elder for one turn"; score 8). Needs 2nd earn in a different game for adoption.** Primary advocate: Stegmaier. |
| A32 Information Architecture Type | 2 | 0 | 0 | 0 | **adopted v2.24.85** | **First earn: ESTUARY #152 (hidden-valuations/obligation type, score 7). Second earn: RITE #153 (hidden-state + involuntary physical leakage, score 7-8) → ADOPTED.** Two subtypes confirmed. Primary advocate: Lacerda/Chvátil. |

## Changelog

- **v2.24.85** — 2026-04-23 — **RITE (game #153; TIGRIS original #31; Chvátil own-anchor A26; Gap 1 E+R first corpus entry). 13 earned. A25↔A26 OP 5-3 (129th TP; NEW PAIR). A27↔A32 OP 5-3 (130th TP; NEW PAIR). A26↔A27 OP 6-2 (128th TP; 2nd instance — CONFIRMED PAIR). A32 ADOPTED (2nd earn ESTUARY+RITE). A31 FIRST EARN (failure texture; "I was Elder for one turn"). Chvátil own-anchor gap closed (89 games since FRACTURE #62). 144th 0-silent-retire.**
...
- **v2.24.31** — 2026-04-21 — **Sleeping Gods (game #100; MILESTONE #100). A25 Emotional Arc adopted** (2nd earn across 2 different games — Betrayal#99 + Sleeping Gods#100). A25↔B2 6-2 (73rd TP; 2nd A25↔B2 — new pair confirmed reliable).
- **v2.24.30** — 2026-04-21 — **Betrayal at House on the Hill (game #99). A25 Emotional Arc FIRST EARN.** A25↔B2 6-2 (72nd TP; new pair).
- **v2.24.11** — 2026-04-21 — **Hive (game #80). A28 Cognitive Load Profile FIRST EARN.** A28↔D2 6-2 (53rd TP; new pair).
- **v2.24.7** — 2026-04-21 — **Klask (game #76). A27 Physical Affordance FIRST EARN.** A27↔D2 6-2 (49th TP; new pair).
- **v2.24.4** — 2026-04-21 — **Wavelength (game #73). A26 Social Contract Dependency adopted** (2nd earn across 2 games — Coup#71 + Wavelength#73; adoption threshold met at game #73, fastest adoption in corpus history — 3 games after axis introduction). A26↔A3 6-2 (46th TP).
- **v2.24.2** — 2026-04-21 — **Coup (game #71). A26 Social Contract Dependency FIRST EARN.** A26↔A3 6-2 (44th TP; new pair).
- **v2.24.1** — 2026-04-21 — **Love Letter (game #70). Fast-track batch start.** A3↔A26 5-3 (43rd TP).
