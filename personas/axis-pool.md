...
|---|---:|---:|---:|---:|---|---|
| A1 Elegance | 11 | 0 | 2 | 0 | **adopted** | Famiglia + ZEN PATH + GARNER + CANTON + Codenames + NEST + WEALD + FURROW + HEARTH + Azul + **Crokinole** (weight-1.61 minimum; 3 rules) earned. |
| A2 Decision Density | 12 | 0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW + HEARTH + Azul + Crokinole earned. |
| A3 Interaction | 13 | 0 | 2 | 1 | **adopted (recovered v2.23; cycle 3)** | TtA + Famiglia + Vigil + Covenstat + CANTON + WEALD + FURROW earned. **v2.23 retirement-reversal (2026-04-20): cycle 3 complete. WEALD #27 (displacement; D2↔A3 OP 6-1) + FURROW #28 (lead/follow; B5↔A3 OP 6-1). Refute-weight 1→0. Contested-watch CLEARED.** Mechanical interaction confirmed across two registers: targeted (displacement) + collective (lead/follow). |
| A4 Variance Calibration | 11 | 0 | 0 | 0 | **adopted** | CoB + Agricola + Pandemic Legacy + GARNER + CANTON + Codenames + WEALD + FURROW + HEARTH + Azul + **Crokinole** (skill-variance canonical) earned. |
| A5 Downtime / Pacing | 6 | 1.0 | 0 | 0 | **adopted** | Famiglia + Tikal + CoB + GARNER + Azul + **Crokinole** (fastest per-turn in corpus) earned. |
| A6 Teachability | 12 | 0 | 1 | 0 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW + HEARTH + Azul + Crokinole (shortest teach) earned. |
| A7 Emergence / Replayability | 16 | 0 | 1 | 0 | **adopted (recovered v2.21; cycle 2)** | Dominion + Scythe + Covenstat + Nemesis + Rewild + GARNER + CANTON earned. **v2.21 retirement-reversal applied (2026-04-20): cycle 2 complete. GARNER #23 (variable contracts; C6↔A7 OP 5-2) + CANTON #24 (faction identity; D2↔A7 Decisive OP 7-1). Refute-weight 1 → 0. Contested-watch CLEARED for second time. Axis returns to standard adopted status.** Counter-pressure cycle 2 mechanisms: structural replayability (variable setup) + identity replayability (asymmetric factions) — two distinct proof-of-concept arguments both earning A7. |
| B1 System Gearing | 10 | 1.5 | 0 | 0 | **adopted** | T&E + Dominion + Pandemic Legacy + GARNER + CANTON + NEST + WEALD + FURROW + HEARTH + Azul earned. Retire-explicit at Crokinole. |
| B2 Catastrophe Pressure | 9 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | Earned extensively. |
| B3 Conversion Chain Depth | 2 | 1.5 | 0 | 0 | **adopted** | PR + TtA earned. Retire-explicit at Codenames + Azul + Crokinole. |
| B4 Information Transparency Cost | 5 | 3.0 | 0 | 0 | **adopted (monitoring; v2.22)** | Dominion + Nemesis + Pandemic Legacy + Codenames + HEARTH earned. Retire-explicit at Azul + Crokinole. **v2.22: 3.0R; earned at HEARTH #29 (2 games ago). Monitoring.** |
| B5 Architectural Novelty | 5 | 4.5 | 0 | 0 | **adopted (monitoring; v2.22)** | Parliament + TtA + Nemesis + Pandemic Legacy + Codenames + FURROW earned. Retire-explicit at HEARTH + Azul + Crokinole. **v2.22: 4.5R; earned at FURROW #28 (3 games ago). Monitoring.** |
| B6 Scoring Multiplier Dependency | 5 | 2.0 | 0 | 0 | **adopted** | UNFOLD + TtA + GARNER + CANTON + **FURROW** (Hops trump multiplier) earned. |
| C1 Tension Budget | 12 | 0 | 0 | 2 | **adopted** | PR + UNFOLD + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW + HEARTH + Azul + Crokinole earned. |
| C2 Minimum-Score Shape | 4 | 5.0 | 0 | 0 | **adopted (dormancy-watch CLEARED v2.22.2)** | CLEARED at NEST #26. Retire-explicit at WEALD + FURROW + HEARTH + Azul + Crokinole (ordinary). |
| C3 Scarcity Bite | 5 | 3.5 | 0 | 1 | **adopted (monitoring; v2.22)** | PR + UNFOLD + GARNER + WEALD + HEARTH earned. Retire-explicit at Crokinole. Clock reset at HEARTH #29. |
| C4 Engine-Garden Dependency | 4 | 3.5 | 1 | 0 | **adopted (monitoring; v2.22)** | Dominion + Scythe + GARNER + CANTON earned. Retire-explicit at Crokinole. **v2.22: 3.5R; earned at CANTON #24 (7 games ago). Approaching 8-game window.** |
...
| C6 Point-Salad Incommensurability | 7 | 4.5 | 0 | 1 | **adopted (monitoring; v2.22)** | FACETS + UNFOLD + GARNER + CANTON + NEST + FURROW + Azul earned. Retire-explicit at Crokinole. **Clock reset at Azul #30 (1 game ago). Monitoring.** |
| C7 Action-Menu Clarity | 9 | 0 | 0 | 0 | **adopted** | PR + UNFOLD + GARNER + CANTON + NEST + WEALD + HEARTH + Azul + **Crokinole** (1 action; clearest in corpus) earned. |
| C8 First-Turn Compression | 4 | 4.0 | 0 | 1 | **adopted (monitoring; v2.22)** | TS + AFoS + Pandemic Legacy + HEARTH earned. Retire-explicit at Azul + Crokinole. **v2.22: 4.0R; earned at HEARTH #29 (2 games ago). Monitoring.** |
| D1 Family-to-Expert Scaling | 9 | 0 | 0 | 2 | **adopted** | Dominion + Scythe + Pandemic Legacy + CANTON + WEALD + FURROW + HEARTH + Azul + **Crokinole** (children → competitive sport) earned. |
| D2 Spatial-Interaction Presence | 7 | 4.0 | 0 | 1 | **adopted (monitoring; v2.22)** | T&E + Scythe + Pandemic Legacy + CANTON + WEALD + **Crokinole** (anchor; Decisive OP 8-0) earned. **Clock reset at Crokinole #31 (0 games ago). Monitoring.** |
| D3 Count-Robustness | 12 | 0 | 0 | 0 | **adopted** | Scythe + ZEN PATH + Tikal + CoB + GARNER + CANTON + Codenames + NEST + WEALD + FURROW + HEARTH + Azul + Crokinole earned. |
| D4 Late-Game Lock-in Point | 7 | 1.0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + NEST + WEALD earned. |
