...
| A3 Interaction | 4 | 1 | 2 | 1 | **adopted** (contested-watch; qualitatively recovered) | TtA + Famiglia + Vigil + **Covenstat** earned. 19th adoption (v2.9). Wingspan self-refute (1 game of refute weight). **Vigil + Covenstat counter-pressure designs both succeeded** (v2.16 I-vigil-01, v2.17 I-covenstat-02) — generalizes across mechanical contexts. Formal refute weight unchanged; qualitative status decisively recovered. |
...
| A7 Emergence / Replayability | 4 | 1 | 1 | 0 | **adopted** (contested-watch; qualitatively recovered) | Dominion + Scythe + **Covenstat (canonical x2)** earned. 8th adoption event (v2.5). AFoS Halifax Hammer structural refute (1 game of refute weight). **Covenstat counter-pressure success** (v2.17 I-covenstat-01) — 12-sheet × shared-dice × private-rubric structurally defeats Halifax Hammer dominance. Formal refute weight unchanged; qualitative status decisively recovered. |
