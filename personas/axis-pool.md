...
| A7 Emergence / Replayability | 4 | 1 | 1 | 0 | **adopted** (contested-watch; awaiting 2nd counter-pressure game) | Dominion + Scythe + Covenstat (canonical x2) earned. 8th adoption event (v2.5). AFoS Halifax Hammer structural refute (1 game of refute weight). Covenstat counter-pressure success (v2.17 I-covenstat-01). **Under v2.18 A-v2.18-01**: retirement-reversal requires ≥ 2 different games of counter-pressure earnings. Covenstat is 1 game (2 sessions ≠ 2 games). **Awaits 1 more counter-pressure earning in a different game** to reduce refute-weight from 1 → 0. |
