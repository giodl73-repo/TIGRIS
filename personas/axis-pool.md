...
| B1 System Gearing | 18 | 1.5 | 0 | 0 | **adopted** | Prior corpus + Cartell #33 + Perihelion #36 (OP) + Brass #37 + QUORUM #41 + Terra Mystica #42 (OP) + Orléans #43 (OP) + RIVENER #44 + TORRENT #47. Retire-explicit from Ticket to Ride, Secret Hitler, SOLSTICE. |
| B2 Catastrophe Pressure | 15 | 3.5 | 0 | 1 | **adopted (monitoring; v2.22)** | Prior corpus + Quacks #34 + Schism #35 (retire-explicit) + QUORUM #41 + Terra Mystica #42 (hold) + Gloomhaven #45 + Secret Hitler #46 (hold) + TORRENT #47 (retire-explicit) + SOLSTICE #50. Earned at 15 games; 3.5R from retire-explicits. Monitoring; earned recently. |
| B3 Conversion Chain Depth | 3 | 4.5 | 0 | 0 | **adopted (monitoring)** | Prior 3 earns; 6 retire-explicits from games #39–50 batch (light-weight games consistently retire-explicit B3). 4.5R — monitoring. Last earned WELLSPRING #32. |
...
| B6 Scoring Multiplier Dependency | 6 | 2.0 | 0 | 0 | **adopted** | No changes from #33–50 batch (hold-explicit in all). |
| C1 Tension Budget | 31 | 0 | 0 | 2 | **adopted** | All corpus + Cartell #33 + Quacks #34 + Schism #35 (hold) + Perihelion #36 (hold) + Brass #37 + Ticket to Ride #39 (anchor OP) + QUORUM #41 (anchor OP) + TORRENT #47 + RftG #48 + Patchwork #49 (Decisive OP) + SOLSTICE #50 (Decisive OP; **career peak**). **Career high tied with A6.** |
...
| C3 Scarcity Bite | 11 | 3.5 | 0 | 1 | **adopted (monitoring; clock reset #41)** | Prior 5 earns + Cartell #33 + Quacks #34 + Schism #35 + Brass #37 (clock reset) + QUORUM #41 + Terra Mystica #42 + RIVENER #44 + SOLSTICE #50. 3.5R unchanged. Earned recently; monitoring. |
| C4 Engine-Garden Dependency | 6 | 4.0 | 1 | 0 | **adopted (monitoring; clock reset WELLSPRING #32)** | Prior 5 earns + Brass #37 earns (factory network; +1). Retire-explicit at Quacks #34 (+0.5R) = 4.0R. Clock reset at WELLSPRING #32; by #50 = 18 games since. **C4 monitoring: earned at #37, 13 games ago. Within 20-game window. Standard monitoring.** |
