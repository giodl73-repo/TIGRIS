...
| A3 Interaction | 3 | 1 | 2 | 1 | **adopted** (contested-watch; reducing) | TtA + Famiglia + **Vigil** earned. 19th adoption (v2.9). Wingspan self-refute (1 game of refute weight). **Vigil counter-pressure defense succeeded** (v2.16 I-vigil-01) — qualitatively reduced from contested-watch but formal refute weight unchanged at 1 game. |
...
| A7 Emergence / Replayability | 2 | 1 | 1 | 0 | **adopted** (contested-watch) | Dominion + Scythe earned. 8th adoption event (v2.5). **AFoS Halifax Hammer structural refute (1 game of refute weight; first adopted-axis formal refute in TIGRIS history).** |
