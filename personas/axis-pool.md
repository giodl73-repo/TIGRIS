...
| A2 Decision Density | 32 | 0 | 0 | 1 | **adopted** | Prior + HAUL #51 + CRUCIBLE #52. |
| A3 Interaction | 32 | 0.5 | 2 | 1 | **adopted (recovered v2.23; cycle 3)** | All corpus earns through #50. Retire-explicit only at 0.5R (no formal refutation post-v2.23 recovery). Monitoring; cycle 3 recovery intact. |
| A4 Variance Calibration | 18 | 0 | 0 | 0 | **adopted** | Prior + CRUCIBLE #52 (LAST-CALL). |
...
| A6 Teachability | 32 | 0 | 1 | 0 | **adopted** | Prior + CRUCIBLE #52. + Schism #35 (light) + Perihelion #36 + Brass #37 + Ticket to Ride #39 + 7 Wonders #40 (OP) + QUORUM #41 + Terra Mystica #42 (hold) + Orléans #43 + RIVENER #44 + Gloomhaven #45 (anchor OP) + Secret Hitler #46 + TORRENT #47 + RftG #48 + Patchwork #49 + SOLSTICE #50. |
...
| B1 System Gearing | 20 | 1.5 | 0 | 0 | **adopted** | Prior + HAUL #51 + CRUCIBLE #52. |
| B2 Catastrophe Pressure | 17 | 3.5 | 0 | 1 | **adopted (monitoring; v2.22)** | Prior + HAUL #51 (spoilage) + **CRUCIBLE #52** (anchor; Decisive OP 7-1). |
...
| B6 Scoring Multiplier Dependency | 8 | 2.0 | 0 | 0 | **adopted** | Prior + HAUL #51 + CRUCIBLE #52 (Artifact 8 VP from 3 components). |
| C1 Tension Budget | 33 | 0 | 0 | 2 | **adopted** | All corpus + Cartell #33 + Quacks #34 + Schism #35 (hold) + Perihelion #36 (hold) + Brass #37 + Ticket to Ride #39 (anchor OP) + QUORUM #41 (anchor OP) + TORRENT #47 + RftG #48 + Patchwork #49 (Decisive OP) + SOLSTICE #50 (Decisive OP; **career peak**). **Career high tied with A6.** |
...
| C6 Point-Salad Incommensurability | 15 | 6.5 | 0 | 1 | **adopted (monitoring; clock reset #52)** | Prior + **CRUCIBLE #52** (Gold/Elixir/Artifact incommensurable paths; B2↔C6 Decisive OP 7-1). Clock reset. | Prior 8 earns + Perihelion #36 (anchor OP; clock reset) + Brass #37 + Terra Mystica #42 (anchor OP) + SOLSTICE #50. Retire-explicit at Cartell #33, Quacks #34, Schism #35, The Crew #38, Ticket to Ride #39, 7 Wonders #40, QUORUM #41 (+0.5R each = +3.5R). 6.5R from retire-explicits; no formal refutation. Earned at SOLSTICE #50 (recent). Monitoring. |
| C7 Action-Menu Clarity | 23 | 0 | 0 | 0 | **adopted** | Prior 10 earns + Quacks #34 + Schism #35 + Perihelion #36 + WELLSPRING + Ticket to Ride #39 + 7 Wonders #40 + QUORUM #41 (hold) + Orléans #43 + TORRENT #47 + Patchwork #49 + SOLSTICE #50. |
...
| D3 Count-Robustness | 28 | 0 | 0 | 0 | **adopted** | Prior + CRUCIBLE #52. |
| D4 Late-Game Lock-in Point | 24 | 1.0 | 0 | 1 | **adopted** | Prior + HAUL #51 (warehouse lock-in) + CRUCIBLE #52 (compound path commitment). |
