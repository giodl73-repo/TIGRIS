...
| A3 Interaction | 2 | 1 | 2 | 1 | **adopted** (contested-watch) | TtA + Famiglia earned. 19th adoption (v2.9). **Wingspan self-refute by Chvátil (multiplayer-solitaire structural; 1 game of refute weight). Second adopted-axis on contested-watch under v2.14 A-v2.14-01.** |
