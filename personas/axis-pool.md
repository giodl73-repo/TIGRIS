...
| A3 Interaction | 4 | 0 | 2 | 1 | **adopted** (recovered via v2.18 retirement-reversal) | TtA + Famiglia + Vigil + Covenstat earned. 19th adoption (v2.9). **v2.18 retirement-reversal applied (2026-04-20): refute-weight reduced 1 → 0 per A-v2.18-01 trigger (2 counter-pressure earnings across 2 different games: Vigil mandatory-discussion + Covenstat public-sheet draft-denial, both collision-vote-confirmed).** Contested-watch cleared formally. Axis returns to standard adopted status. |
...
| A5 Downtime / Pacing | 3 | 0.5 | 0 | 0 | **adopted** | Famiglia + Tikal (LAST-CALL) + CoB earned. 22nd adoption (v2.11). **First A5 retire-explicit at Covenstat (v2.17; 5p clockwise-draft downtime)** — boundary conditions now visible per I-covenstat-03. |
| A6 Teachability | 2 | 0 | 1 | 0 | **adopted** | FACETS earned + Dominion earned (LAST-CALL). |
| A7 Emergence / Replayability | 8 | 0 | 1 | 0 | **adopted** (recovered via v2.19 retirement-reversal) | Dominion + Scythe + Covenstat (canonical x2) + Nemesis + **Rewild (canonical x3)** earned. 8th adoption event (v2.5). **v2.19 retirement-reversal applied (2026-04-20): refute-weight reduced 1 → 0 per A-v2.18-01 trigger (2 counter-pressure-designed games: Covenstat 12-sheet catalog + Rewild 80-card Wildlife deck, both collision-vote-confirmed).** Contested-watch cleared formally. Axis returns to standard adopted status. |
...
| C3 Scarcity Bite | 2 | 1 | 0 | 1 | **adopted** | PR + UNFOLD earned. 13th adoption (v2.7). Retirement queue permanently cleared. |
...
| C6 Point-Salad Incommensurability | 2 | 1.0 | 0 | 1 | **adopted** | FACETS (Feld anchor) + UNFOLD (Feld) earned. 14th adoption (v2.7). Contested history resolved. |
| C7 Action-Menu Clarity | 2 | 0 | 0 | 0 | **adopted** | PR + UNFOLD LAST-CALL earned. 15th adoption (v2.7). Pool now 60% adopted. |
| C8 First-Turn Compression | 2 | 0.5 | 0 | 1 | **adopted** | TS + AFoS earned. **24th adoption (v2.14).** Pool at 96%. Stegmaier-primary. 14-game dormancy → 2-game close-out. Matches A4 dormancy-recovery pattern. |
...
| D3 Count-Robustness | 3 | 0 | 0 | 0 | **adopted** | Scythe + ZEN PATH + Tikal + CoB earned. 21st adoption (v2.11). Stegmaier-primary signature. **Band D fully adopted (4/4).** |
...
| 2026-04-20 | A7 Emergence-Replayability | 1 → 0 | Covenstat #19 (12-sheet catalog + shared-dice private-rubric) + Rewild #21 (80-card Wildlife deck + 5-biome scoring variance) | Covenstat A7↔A6 (A7 earned canonical); Rewild C3↔C4 (A7 earned canonical x3 independently) | v2.19 A-v2.18-01 forward application
