...
|---|---:|---:|---:|---:|---|---|
| A1 Elegance | 4 | 0 | 2 | 0 | **adopted** | Famiglia + ZEN PATH + GARNER + CANTON (LAST-CALL) earned. |
| A2 Decision Density | 5 | 0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON earned. |
| A3 Interaction | 7 | 0 | 2 | 1 | **adopted** (recovered via v2.18 retirement-reversal) | TtA + Famiglia + Vigil + Covenstat earned. 19th adoption (v2.9). **v2.18 retirement-reversal applied (2026-04-20): refute-weight reduced 1 → 0 per A-v2.18-01 trigger (2 counter-pressure earnings across 2 different games: Vigil mandatory-discussion + Covenstat public-sheet draft-denial, both collision-vote-confirmed).** Contested-watch cleared formally. Axis returns to standard adopted status. |
| A4 Variance Calibration | 5 | 0 | 0 | 0 | **adopted** | CoB + Agricola + Pandemic Legacy + GARNER + CANTON (LAST-CALL) earned. |
| A5 Downtime / Pacing | 4 | 1.0 | 0 | 0 | **adopted** | Famiglia + Tikal + CoB + GARNER (simultaneous-placement) earned. |
| A6 Teachability | 5 | 0 | 1 | 0 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON earned. |
| A7 Emergence / Replayability | 10 | 0 | 1 | 0 | **adopted (recovered v2.21; cycle 2)** | Dominion + Scythe + Covenstat + Nemesis + Rewild + GARNER + CANTON earned. **v2.21 retirement-reversal applied (2026-04-20): cycle 2 complete. GARNER #23 (variable contracts; C6↔A7 OP 5-2) + CANTON #24 (faction identity; D2↔A7 Decisive OP 7-1). Refute-weight 1 → 0. Contested-watch CLEARED for second time. Axis returns to standard adopted status.** Counter-pressure cycle 2 mechanisms: structural replayability (variable setup) + identity replayability (asymmetric factions) — two distinct proof-of-concept arguments both earning A7. |
| B1 System Gearing | 5 | 0.5 | 0 | 0 | **adopted** | T&E + Dominion + Pandemic Legacy + GARNER + CANTON earned. |
| B2 Catastrophe Pressure | 5 | 2.5 | 0 | 1 | **adopted** | T&E + TtA earned (canonical salvage). 16th adoption (v2.8). Retirement threshold reversed. |
...
| B4 Information Transparency Cost | 3 | 1.0 | 0 | 0 | **adopted** | Dominion + Nemesis + Pandemic Legacy earned. Retire-explicit at GARNER + CANTON (public faction cards; transparent map). |
| B5 Architectural Novelty | 3 | 2.0 | 0 | 0 | **adopted ⚑** | Parliament + TtA + Nemesis + Pandemic Legacy earned. Retire-explicit at GARNER + CANTON (both disclaim novelty). **⚑ B5 at 2.0R; I-pandemic-04 cluster.** |
| B6 Scoring Multiplier Dependency | 4 | 0.5 | 0 | 0 | **adopted** (new-axis v2.6) | UNFOLD + TtA + GARNER + CANTON (Merchant chain/Engineer Road multipliers) earned. |
| C1 Tension Budget | 5 | 0 | 0 | 2 | **adopted** | PR + UNFOLD + Pandemic Legacy + GARNER + CANTON earned. |
| C2 Minimum-Score Shape | 3 | 2.0 | 0 | 0 | **adopted ⚑** | Adopted; retire-explicit accumulating. **⚑ C2 at 2.0R after CANTON — I-pandemic-04 cluster (B5/C2/C4 all at 2.0R). v2.21 protocol-gap amendment required.** |
| C3 Scarcity Bite | 3 | 1.5 | 0 | 1 | **adopted** | PR + UNFOLD + GARNER earned. |
| C4 Engine-Garden Dependency | 4 | 2.0 | 1 | 0 | **adopted ⚑** | Dominion + Scythe + GARNER + CANTON earned. **⚑ C4 at 2.0R (all retire-explicit; never formally refuted). I-pandemic-04 cluster.** |
...
| C6 Point-Salad Incommensurability | 4 | 1.5 | 0 | 1 | **adopted** | FACETS + UNFOLD + GARNER + CANTON (faction era-bonus incommensurability) earned. |
| C7 Action-Menu Clarity | 4 | 0 | 0 | 0 | **adopted** | PR + UNFOLD + GARNER + CANTON earned. |
| C8 First-Turn Compression | 3 | 0.5 | 0 | 1 | **adopted** | TS + AFoS + Pandemic Legacy (OP A6↔C8, setup-overhead temporal register) earned. |
| D1 Family-to-Expert Scaling | 4 | 0 | 0 | 2 | **adopted** | Dominion + Scythe + Pandemic Legacy + CANTON (faction-gradient) earned. |
| D2 Spatial-Interaction Presence | 5 | 1.5 | 0 | 1 | **adopted** | T&E + Scythe + Pandemic Legacy + CANTON (anchor; Decisive OP 7-1) earned. |
| D3 Count-Robustness | 5 | 0 | 0 | 0 | **adopted** | Scythe + ZEN PATH + Tikal + CoB + GARNER + CANTON earned. |
| D4 Late-Game Lock-in Point | 5 | 0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON earned. |
