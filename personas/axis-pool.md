...
| A7 Emergence / Replayability | 5 | 1 | 1 | 0 | **adopted** (contested-watch; awaiting 2nd counter-pressure game) | Dominion + Scythe + Covenstat (canonical x2) + **Nemesis** earned. 8th adoption event (v2.5). AFoS Halifax Hammer structural refute (1 game of refute weight). Covenstat counter-pressure success (v2.17 I-covenstat-01). **Nemesis earning is ORDINARY, not counter-pressure** (reviews don't qualify for v2.18 trigger per I-nemesis-04). **Awaits 1 more counter-pressure-designed-original earning in a different game** to reduce refute-weight from 1 → 0. |
