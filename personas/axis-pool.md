...
|---|---:|---:|---:|---:|---|---|
| A1 Elegance | 8 | 0 | 2 | 0 | **adopted** | Famiglia + ZEN PATH + GARNER + CANTON + Codenames + NEST + WEALD + FURROW earned. |
| A2 Decision Density | 9 | 0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW earned. |
| A3 Interaction | 10 | 0 | 2 | 1 | **adopted (recovered v2.23; cycle 3)** | TtA + Famiglia + Vigil + Covenstat + CANTON + WEALD + FURROW earned. **v2.23 retirement-reversal (2026-04-20): cycle 3 complete. WEALD #27 (displacement; D2↔A3 OP 6-1) + FURROW #28 (lead/follow; B5↔A3 OP 6-1). Refute-weight 1→0. Contested-watch CLEARED.** Mechanical interaction confirmed across two registers: targeted (displacement) + collective (lead/follow). |
| A4 Variance Calibration | 8 | 0 | 0 | 0 | **adopted** | CoB + Agricola + Pandemic Legacy + GARNER + CANTON + Codenames + WEALD + FURROW earned. |
| A5 Downtime / Pacing | 4 | 1.0 | 0 | 0 | **adopted** | Famiglia + Tikal + CoB + GARNER earned. |
| A6 Teachability | 9 | 0 | 1 | 0 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW earned. |
| A7 Emergence / Replayability | 14 | 0 | 1 | 0 | **adopted (recovered v2.21; cycle 2)** | Dominion + Scythe + Covenstat + Nemesis + Rewild + GARNER + CANTON earned. **v2.21 retirement-reversal applied (2026-04-20): cycle 2 complete. GARNER #23 (variable contracts; C6↔A7 OP 5-2) + CANTON #24 (faction identity; D2↔A7 Decisive OP 7-1). Refute-weight 1 → 0. Contested-watch CLEARED for second time. Axis returns to standard adopted status.** Counter-pressure cycle 2 mechanisms: structural replayability (variable setup) + identity replayability (asymmetric factions) — two distinct proof-of-concept arguments both earning A7. |
| B1 System Gearing | 8 | 1.0 | 0 | 0 | **adopted** | T&E + Dominion + Pandemic Legacy + GARNER + CANTON + NEST + WEALD + FURROW earned. |
| B2 Catastrophe Pressure | 8 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | Earned extensively. Retire-explicit at FURROW (renege penalty not escalating catastrophe). | T&E + TtA earned (canonical salvage). 16th adoption (v2.8). Retirement threshold reversed. |
...
| B5 Architectural Novelty | 5 | 3.0 | 0 | 0 | **adopted (monitoring; v2.22)** | Parliament + TtA + Nemesis + Pandemic Legacy + Codenames + **FURROW** earned. Clock reset. |
| B6 Scoring Multiplier Dependency | 5 | 2.0 | 0 | 0 | **adopted** | UNFOLD + TtA + GARNER + CANTON + **FURROW** (Hops trump multiplier) earned. |
| C1 Tension Budget | 9 | 0 | 0 | 2 | **adopted** | PR + UNFOLD + Pandemic Legacy + GARNER + CANTON + Codenames + NEST + WEALD + FURROW earned. |
| C2 Minimum-Score Shape | 4 | 3.5 | 0 | 0 | **adopted (dormancy-watch CLEARED v2.22.2)** | CLEARED at NEST #26. Retire-explicit at WEALD + FURROW (ordinary accumulation). |
| C3 Scarcity Bite | 4 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | PR + UNFOLD + GARNER + WEALD earned. Retire-explicit at FURROW. **v2.22: 3.0R; earned at WEALD #27 (1 game ago). Monitoring.** |
| C4 Engine-Garden Dependency | 4 | 3.0 | 1 | 0 | **adopted (monitoring; v2.22)** | Dominion + Scythe + GARNER + CANTON earned. **v2.22: 3.0R; earned at CANTON #24 (3 games ago). Monitoring.** |
...
| C6 Point-Salad Incommensurability | 6 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | FACETS + UNFOLD + GARNER + CANTON + NEST + **FURROW** (Flax/Grain/Hops incommensurable paths) earned. Clock reset. |
| C7 Action-Menu Clarity | 6 | 0 | 0 | 0 | **adopted** | PR + UNFOLD + GARNER + CANTON + NEST + WEALD earned. |
| C8 First-Turn Compression | 3 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | TS + AFoS + Pandemic Legacy earned. Retire-explicit at NEST + WEALD + FURROW. **v2.22: 3.0R; earned at Pandemic Legacy #22 (6 games ago). Monitoring.** | TS + AFoS + Pandemic Legacy (OP A6↔C8, setup-overhead temporal register) earned. |
| D1 Family-to-Expert Scaling | 6 | 0 | 0 | 2 | **adopted** | Dominion + Scythe + Pandemic Legacy + CANTON + WEALD + FURROW earned. |
| D2 Spatial-Interaction Presence | 6 | 3.5 | 0 | 1 | **adopted (monitoring; v2.22)** | T&E + Scythe + Pandemic Legacy + CANTON + WEALD earned. Retire-explicit at FURROW. **v2.22: 3.5R; earned at WEALD #27 (1 game ago). Monitoring.** |
| D3 Count-Robustness | 9 | 0 | 0 | 0 | **adopted** | Scythe + ZEN PATH + Tikal + CoB + GARNER + CANTON + Codenames + NEST + WEALD + FURROW earned. |
