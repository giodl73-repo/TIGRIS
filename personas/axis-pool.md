...
|---|---:|---:|---:|---:|---|---|
| A1 Elegance | 6 | 0 | 2 | 0 | **adopted** | Famiglia + ZEN PATH + GARNER + CANTON + Codenames + **NEST** earned. |
| A2 Decision Density | 7 | 0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST earned. |
| A3 Interaction | 8 | 1 | 2 | 1 | **adopted (CONTESTED-WATCH re-entered; post-v2.21)** | TtA + Famiglia + Vigil + Covenstat + CANTON earned (most recent). **NEST #26: first post-v2.21 refutation** — C6↔A3 CR 5-1 (Feld); NEST is multiplayer-solitaire on parallel boards. A3 at 8E/1R. Counter-pressure needed: ≥2 designed originals with mandatory direct interaction (new cycle). | | TtA + Famiglia + Vigil + Covenstat earned. 19th adoption (v2.9). **v2.18 retirement-reversal applied (2026-04-20): refute-weight reduced 1 → 0 per A-v2.18-01 trigger (2 counter-pressure earnings across 2 different games: Vigil mandatory-discussion + Covenstat public-sheet draft-denial, both collision-vote-confirmed).** Contested-watch cleared formally. Axis returns to standard adopted status. |
| A4 Variance Calibration | 6 | 0 | 0 | 0 | **adopted** | CoB + Agricola + Pandemic Legacy + GARNER + CANTON + Codenames earned. |
| A5 Downtime / Pacing | 4 | 1.0 | 0 | 0 | **adopted** | Famiglia + Tikal + CoB + GARNER (simultaneous-placement) earned. |
| A6 Teachability | 7 | 0 | 1 | 0 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + Codenames + NEST earned. |
| A7 Emergence / Replayability | 12 | 0 | 1 | 0 | **adopted (recovered v2.21; cycle 2)** | Dominion + Scythe + Covenstat + Nemesis + Rewild + GARNER + CANTON earned. **v2.21 retirement-reversal applied (2026-04-20): cycle 2 complete. GARNER #23 (variable contracts; C6↔A7 OP 5-2) + CANTON #24 (faction identity; D2↔A7 Decisive OP 7-1). Refute-weight 1 → 0. Contested-watch CLEARED for second time. Axis returns to standard adopted status.** Counter-pressure cycle 2 mechanisms: structural replayability (variable setup) + identity replayability (asymmetric factions) — two distinct proof-of-concept arguments both earning A7. |
| B1 System Gearing | 6 | 1.0 | 0 | 0 | **adopted** | T&E + Dominion + Pandemic Legacy + GARNER + CANTON + NEST earned. |
| B2 Catastrophe Pressure | 7 | 2.5 | 0 | 1 | **adopted** | T&E + TtA earned (canonical salvage). 16th adoption (v2.8). Retirement threshold reversed. |
| B3 Conversion Chain Depth | 2 | 0.5 | 0 | 0 | **adopted** | PR + TtA (LAST-CALL) earned. Retire-explicit at Codenames. |
| B4 Information Transparency Cost | 4 | 1.5 | 0 | 0 | **adopted** | Dominion + Nemesis + Pandemic Legacy + Codenames earned. Retire-explicit at NEST. |
| B5 Architectural Novelty | 4 | 2.5 | 0 | 0 | **adopted (monitoring; v2.22)** | Parliament + TtA + Nemesis + Pandemic Legacy + Codenames earned. Retire-explicit at NEST. **v2.22: 2.5R; earned at Codenames #25 (1 game ago). Monitoring.** |
| B6 Scoring Multiplier Dependency | 4 | 2.0 | 0 | 0 | **adopted (monitoring; v2.22)** | UNFOLD + TtA + GARNER + CANTON earned. Retire-explicit at Codenames + NEST. **v2.22: 2.0R; earned at CANTON #24 (2 games ago). Monitoring.** |
| C1 Tension Budget | 7 | 0 | 0 | 2 | **adopted** | PR + UNFOLD + Pandemic Legacy + GARNER + CANTON + Codenames + NEST earned. |
| **C2 Minimum-Score Shape** | **4** | 2.5 | 0 | 0 | **adopted (dormancy-watch CLEARED v2.22.2)** | **DORMANCY-WATCH CLEARED at NEST #26** (2 VP floor per Decade Rubric = 6 VP minimum total; designed floor confirmed by panel). C2 returns to standard adopted status. Dormancy-watch clock reset from game #26. |
| C3 Scarcity Bite | 3 | 2.5 | 0 | 1 | **adopted (monitoring; v2.22)** | PR + UNFOLD + GARNER earned. Retire-explicit at Codenames + NEST. **v2.22: 2.5R; earned at GARNER #23 (3 games ago). Monitoring.** |
| C4 Engine-Garden Dependency | 4 | 3.0 | 1 | 0 | **adopted (monitoring; v2.22)** | Dominion + Scythe + GARNER + CANTON earned. Retire-explicit at Codenames + NEST. **v2.22: 3.0R; earned at CANTON #24 (2 games ago). Monitoring.** |
...
| C6 Point-Salad Incommensurability | 5 | 2.5 | 0 | 1 | **adopted (monitoring; v2.22)** | FACETS + UNFOLD + GARNER + CANTON + **NEST** (anchor) earned. **v2.22: 2.5R; earned at NEST #26 (0 games ago). Monitoring clock reset.** |
| C7 Action-Menu Clarity | 5 | 0 | 0 | 0 | **adopted** | PR + UNFOLD + GARNER + CANTON + NEST earned. |
| C8 First-Turn Compression | 3 | 2.0 | 0 | 1 | **adopted (monitoring; v2.22)** | TS + AFoS + Pandemic Legacy earned. Retire-explicit at NEST. **v2.22: 2.0R; earned at Pandemic Legacy #22 (4 games ago). Monitoring.** | TS + AFoS + Pandemic Legacy (OP A6↔C8, setup-overhead temporal register) earned. |
| D1 Family-to-Expert Scaling | 4 | 0 | 0 | 2 | **adopted** | Dominion + Scythe + Pandemic Legacy + CANTON (faction-gradient) earned. |
| D2 Spatial-Interaction Presence | 5 | 3.0 | 0 | 1 | **adopted (monitoring; v2.22)** | T&E + Scythe + Pandemic Legacy + CANTON earned. Retire-explicit at Codenames + NEST. **v2.22: 3.0R; earned at CANTON #24 (2 games ago). Monitoring.** |
| D3 Count-Robustness | 7 | 0 | 0 | 0 | **adopted** | Scythe + ZEN PATH + Tikal + CoB + GARNER + CANTON + Codenames + NEST earned. |
| D4 Late-Game Lock-in Point | 6 | 1.0 | 0 | 1 | **adopted** | FACETS + Dominion + Pandemic Legacy + GARNER + CANTON + NEST earned. |
