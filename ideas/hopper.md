...
### HOP-035 — Reading the Runes: World's End
- **One-liner:** A 2–5 player competitive-survival investigation game played around a physical World Engine: a pegged globe in a gimbal, a Sun, and movable celestial bodies. Rival expeditions compete for access to the Great Pyramid and other monuments, connect fragmentary evidence into catastrophe theories, and equip their civilizations before the concealed cosmology resolves physically through impacts, floods, solar eruptions, glacial failures, planetary close approaches, plasma strikes, or an ECDO-style Earth flip.
- **Anchor guess:** kramer-kiesling / A27
- **Sources:** primitives (P-002 cosmic/space + P-011 area-control/influence + P-014 lock-in); mashup (M-003 rondel x cosmic, extended into a physical orrery); corpus contrast (DELUGE #67 single-hazard flood pressure, CRUCIBLE #52 shared catastrophe engine, Spirit Island #66 cascading threat); session synthesis (monument-control archaeology, competing cosmologies, evidence-to-equipment chains, asymmetric investigators including the AI-assisted Vibe Coder, speculative zero-point/UFO-like technology, and Velikovsky-inspired Worlds in Collision mode)
- **Tension hypothesis:** Kramer-Kiesling defends A27 because geography, orientation, solar exposure, orbital proximity, and catastrophe resolution are performed on the physical World Engine; replacing it with tracks should destroy essential spatial information and the game's climactic act. Chvatil challenges on B5: is the globe a genuinely load-bearing information-and-resolution architecture, or a spectacular toy surrounding familiar deduction and event-deck systems? Primary predicted collision: A27<->B5 OP -- physical necessity versus architectural novelty. Secondary: B2<->A31 -- the catastrophe's mechanical punishment versus whether a failed civilization leaves a retellable history.
- **Status:** fresh
- **Created:** 2026-08-01
- **Updated:** 2026-08-01
- **Notes:** Distinct from DELUGE: multiple competing world-models are inferred from monument evidence, and the selected cosmology changes the physical behavior of the shared globe. Scientific, historical, fringe, and fictional claims must be labeled by epistemic status; the game may make speculative cosmologies true within a scenario without presenting them as equally supported accounts of real Earth history. Working modes include Historical Earth, Fire and Ice, Worlds in Collision, Earth in Motion, Ancient Machine, and Everything Is Connected.

### HOP-034 — Euro-Charades (codename)
- **One-liner:** A 3–6 player spatial social game built on four stacked layers: (1) a card economy of Signal / Misdirect / Combo cards that tell you what to perform and how; (2) physical performance in the Charades tradition where the reading question is not "what is it" but "what is this *actually pointing at* — signal or misdirect?"; (3) live Reaction cards (Dominion Moat DNA) that sit face-up and fire when another player's performance hits a specific trigger, letting you immediately move or act; (4) spatial zones — you occupy and move between physical positions in the room, movement triggered by reactions and combo plays. The room is live all the time: nobody is just watching.
- **Anchor guess:** chvatil / A26
- **Sources:** gap (docs/tiger-beat-gaps.md Gap 1 E+R — 0 corpus games at E≥7 + R≥7; nearest Codenames at dist=3.5); primitives (P-013 simultaneous action + P-015 hidden role); session research synthesis (Twister: spatial zones as resource; Johnny Whoops: misdirection-as-designed-mechanic; Wavelength + Mysterium: reading-what-it-points-at not what-it-is; Dominion reactions: live engagement during others' turns; True American: people moving through physical space)
- **Tension hypothesis:** Chvátil defends A26 — the game's social contract is the reading norm: when you perform, everyone must decide simultaneously whether this is straight, misdirected, or a combo. That collective interpretive act is implicit — not rule-encoded. A27 earns because bodies executing gestures in physical space is non-digitizable (the spatial zone movement, the performance quality, the reaction timing are all load-bearing physical acts). Primary predicted collision: A26↔A27 OP — social contract (A26: the interpretive norm that makes misdirection work) vs. physical affordance (A27: body-in-space is the scoring surface). Secondary: B5↔A26 — architectural novelty (B5: Reaction-card-triggered spatial movement during others' performances has no corpus sibling) vs. social contract (A26: the norm that sustains it). Gap 1 E+R: A26+A27 drive E; card-hand variance + zone configuration drive R.
- **Status:** consumed
- **Created:** 2026-04-23
- **Updated:** 2026-04-23
- **Notes:** Codename Euro-Charades evolved through design exploration into two distinct games: RITE (games/0153-rite/ — Gap 1 E+R euro-adjacent, TIGRIS pipeline) and UPSTAGE (party game, future PARLOR pipeline). consumed by games/0153-rite/
