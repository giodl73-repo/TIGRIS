...
- **Created:** 2026-04-23
- **Updated:** 2026-04-23
- **Notes:** Codename only — not the final name. Win condition deliberately unpinned at hopper stage. Four layers identified; concept.md should hold them loosely and flag win condition + weight target as primary open questions. First TIGRIS original targeting Gap 1 E+R. Design gap nearest: Codenames (dist=3.5). Target: E=8, R=8. Weight ceiling: ≤2.0.
